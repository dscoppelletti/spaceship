...
/**
 * Default implementation of `CurrencyConverter` interface.
 *
 * @since 1.0.0
 *
 ...
 */
public class DefaultCurrencyConverter(
        fractionDigits: Int?,
    ...
    override val currencySymbol: String
        get() = format.currency.currencyCode

    override fun defaultFractionDigits(format: NumberFormat): Int =
            format.currency.defaultFractionDigits
}