...
class DecimalConverter0GroupingTest {
    ...
    fun setUp() {
        ...
        decimalConverter = i18nProvider.decimalConverter(0, true)
    }
    ...
    fun format() {
        ...
        assertEquals("2.100", decimalConverter.format(x), "2100")

        x = BigDecimal.valueOf(-2100.25)
        assertEquals("-2.100", decimalConverter.format(x), "-2100.25")

        x = BigDecimal.valueOf(2101)
        assertEquals("2.101", decimalConverter.format(x), "2100.5572")
    }
    ...
    fun parse() {
        ...
        actual = decimalConverter.parse("2.100,5577")
        expected = BigDecimal.valueOf(2101)
