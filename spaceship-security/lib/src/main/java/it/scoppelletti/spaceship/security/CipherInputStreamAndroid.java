 ...
 * Repository: http://android.googlesource.com/platform/libcore
 * File: master/ojluni/src/main/java/javax/crypto/CipherInputStream.java
 * Commit: b1fb0c291caf4025e060b81cba92a3299a8b8033 - February 22, 2017
 * Rename to CipherInputStreamAndroid.
 * Make internal.
...
class CipherInputStreamAndroid extends FilterInputStream {
     ...
     */
    public CipherInputStreamAndroid(InputStream is, Cipher c) {
        super(is);
        input = is;
        cipher = c;
    }
